...
(function() {
  ...
  this.MMD = (function() {
    ...
    MMD.prototype.EVBMove=function(rot_x,rot_y){
      var _this = this;
      
        _this.rotx -=rot_x * Math.PI / 180;//‰ñ“]XŽ²
        _this.roty -=rot_y * Math.PI / 180;//‰ñ“]YŽ²
          
        return _this.redraw = true;
    };
    
    MMD.prototype.EVBMoveX = function(a) {
      var _this = this;
      
        _this.rotx +=a * Math.PI / 180;
         
        return _this.redraw = true;
    };
    
    MMD.prototype.EVBMoveZ = function(a) {
      var _this = this;
      
        _this.roty +=a * Math.PI / 180;
         
        return _this.redraw = true;
    };
    
    MMD.prototype.EVBMoveDefault=function(){
      var _this = this;
